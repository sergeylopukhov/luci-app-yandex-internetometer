...
![Интерфейс Интернетометра](docs/screenshot-v1.0.14.png)
<p align="center">
...
Завершённые измерения сохраняются на роутере. В LuCI можно посмотреть график за 7, 30 или 90 дней, сравнить средние показатели с предыдущим периодом и выгрузить выбранный период в CSV или JSON. История ограничена 200 записями и не содержит публичный IP.
